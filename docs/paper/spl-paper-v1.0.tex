...
The author thanks Claude (Anthropic) for its role as an AI development partner throughout
this project. The SPL engine, test suite, and initial draft of this paper were developed
in close collaboration with Claude, whose ability to implement, synthesise, and iterate
on complex system designs substantially accelerated the work. While academic publishing
conventions preclude AI co-authorship, the contribution was integral and is gratefully
acknowledged.
